...
const PROTECTED_ROUTES = [
  ...
  { path: "/erp/ai-content", name: "ERP AI Content" },
  ...
  { path: "/saas/tenants", name: "SaaS Tenants" },
  { path: "/saas/usage", name: "SaaS Usage" },
  { path: "/saas/branches", name: "SaaS Branches" },
