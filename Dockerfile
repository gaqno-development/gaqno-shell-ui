...
ARG MFE_OMNICHANNEL_URL=http://localhost:3011
ARG MFE_WELLNESS_URL=http://localhost:3012
ARG MFE_ADMIN_URL=http://localhost:3010
ARG MFE_INTELLIGENCE_URL=http://localhost:3013
ARG MFE_CONSUMER_URL=http://localhost:3015

ARG VITE_SERVICE_SSO_URL=http://localhost:4001
ARG VITE_SERVICE_AI_URL=http://localhost:4002
ARG VITE_SERVICE_CRM_URL=http://localhost:4003
ARG VITE_SERVICE_ERP_URL=http://localhost:4004
...
ARG VITE_SERVICE_OMNICHANNEL_URL=http://localhost:4008
...
ENV MFE_WELLNESS_URL=$MFE_WELLNESS_URL
ENV MFE_ADMIN_URL=$MFE_ADMIN_URL
ENV MFE_INTELLIGENCE_URL=$MFE_INTELLIGENCE_URL
ENV MFE_CONSUMER_URL=$MFE_CONSUMER_URL
