...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-z-BZoSEI.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-KmrQF9Fk.js', import.meta.url).href),import:true},'tailwindcss':{get:()=>()=>__federation_import(new URL('__federation_shared_tailwindcss-DUFRkgTj.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-CjrlCwlf.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-CmXtza7B.js', import.meta.url).href),import:true},'tailwindcss':{get:()=>()=>__federation_import(new URL('__federation_shared_tailwindcss-DUFRkgTj.js', import.meta.url).href),import:true}};
